...
public class CommentOneController {
    ...
    public String doCommentOne(@RequestBody CaCommentOne caCommentOne){
        System.out.println(caCommentOne.getComment());
        String[] sensitiveWord = sensitive.split( " ");
        for (String s : sensitiveWord) {
            System.out.println(s);
            if (caCommentOne.getComment().contains(s)){
                return "200";
            }
        }
        try {
